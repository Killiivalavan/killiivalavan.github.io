...
export default function BucketListSection() {
  return (
    <div className="w-full h-full pt-8 pb-24">
      <div className="w-full max-w-[800px] flex flex-col items-start px-2 sm:px-8">
        <h1 className="text-4xl sm:text-5xl font-serif text-left mb-6 text-foreground tracking-tight">Bucket List</h1>
        
        <p className="text-[14px] sm:text-[15px] text-left text-muted-foreground mb-12">
          inspired by <a href="https://prarthanagarwal.me/bucket-list" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors underline decoration-muted-foreground/40 underline-offset-4 cursor-pointer">Prarthan Agarwal</a> - these are the things that can make me feel infinite!
        </p>
